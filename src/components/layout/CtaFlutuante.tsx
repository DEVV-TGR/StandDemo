...
export function CtaFlutuante() {
  ...
  return (
    <a
      ...
      className={`gold-metal-fill press fixed bottom-6 right-6 z-40 flex items-center gap-2 rounded-full px-5 py-3 text-sm font-medium text-background shadow-lg shadow-black/40 ${
